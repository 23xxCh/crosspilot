...
from .congestion import CongestionPolicy
from .deepseek import DeepSeekProvider
from .errors import ProviderError, ProviderQuotaError
...
class CompositeProvider(ModelProvider):
    ...
    def __init__(self, config: dict) -> None:
        ...
        self._circuit_threshold = max(
            ...
            int(
                os.environ.get(
                    "CROSSPILOT_CIRCUIT_FAILURE_THRESHOLD",
                    "8",
                )
            ),
        )
    ...
    def _configure_image(self, config: dict) -> None:
        ...
        gpt_key = (
            ...
            or os.environ.get("CROSSPILOT_GPT_IMAGE_KEY", "")
        )
